...
namespace ConsoleTest
{
    public static class DynamicCodeManager
    {
        ...
        private static readonly string codeStart
            = "using System;" + nl
        ...
        private static DynamicBase GetDynamic()
        {
            if (Assembly == null)
                Compile();
            if (Assembly == null)
                throw new InvalidOperationException("Could not compile source to Assembly.");
            var instance = Assembly.CreateInstance(myNamespace + ".Dynamic");
            var dynamicBase = instance as DynamicBase;
            if (dynamicBase == null)
            {
                throw new InvalidOperationException("Instance could not be converted to DynamicBase");
            }
            return dynamicBase;
        }
        ...
        {
            var dynamicMethod = GetDynamic();
            if (dynamicMethod == null)
                throw new InvalidOperationException("Instance is not of DynamicBase");
            try
            {
        ...
        {
            var dynamicCondition = GetDynamic();
        ...
        {
            DynamicBase dynamicCondition = GetDynamic();
